    ...
    <v-app-bar flat
      ...
      <v-menu offset-y>
        <template v-slot:activator="{ on, attrs }">
          <v-btn text slot="activator" color="grey" v-bind="attrs"
                 v-on="on">
        ...
        <v-list>
          <v-list-item v-for="link in links" :key="link.text" router :to="link.router">
            <v-list-item-title>
              <v-icon small class="mx-1">{{ link.icon }}</v-icon>
      ...
      <v-col align-self="center">
        <v-flex class="mt-5">
          <div class="text-center">
            <v-avatar size="130">
              <img src="../../public/yoshi.png" elt="network Error">
            </v-avatar>
          </div>
